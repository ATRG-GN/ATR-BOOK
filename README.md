...
> **สถานะต้นแบบปัจจุบัน:** ใน repository นี้เป็นต้นแบบหน้าจอแสดงรายการฟีเจอร์ (ยังไม่ครอบคลุมฟีเจอร์ AI, TTS, แนบไฟล์ และส่งออก PDF ตามเอกสารเชิงสถาปัตยกรรมทั้งหมด)
