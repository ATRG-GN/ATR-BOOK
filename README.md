...
> **สถานะต้นแบบปัจจุบัน:** ใน repository นี้เป็นตัวอย่างต้นแบบที่แสดงรายการ backlog ของฟีเจอร์ในหน้าเดียว (ยังไม่ครอบคลุมฟีเจอร์ AI, TTS, แนบไฟล์ และส่งออก PDF ตามเอกสารเชิงสถาปัตยกรรมทั้งหมด)
